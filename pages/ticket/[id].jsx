...
export default function DetailTicket(){
  ...
  const { data, error } = useSwr(`/api/static/${id}/ticket`, fetcher)
        ...
        <div className="w-full md:w-1/4">
          ...
          <div className="bg-white p-4 rounded">
            ...
            <div className="w-full justify-center flex">
              <Image src={data.sender.photo} width={150} height={150} className="rounded-full"></Image>          
            </div>
        ...
        <div className="w-full md:w-3/4">
          <div className="w-full bg-white rounded p-4 space-y-3">
            ...
            <div className="">
              ...
              <textarea type="text" className="w-full h-24 border rounded border-gray-300 pl-3 py-2 text-gray-700 text-xs" 
              value={data.desc} />
            </div>
            ...
            <div className="mt-6">
              <button onClick={()=>router.push("/ticket")} className="text-xs text-center w-full border border-gray-400 rounded py-2">
                Back Ticket
              </button>
            </div>
